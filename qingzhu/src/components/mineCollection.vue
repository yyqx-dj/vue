<template>
<div>
      <div data-v-a9859a0c="" class="s-empty-pc">
        <span data-v-a9859a0c="" class="s-icon-size-pc">
            <svg data-v-a9859a0c="" aria-hidden="true" class="sk-icon">
                <use xlink:href="#sk-icon-no_favorite">
...
.sk-icon {
    width: 1em;
    height: 1em;
    vertical-align: calc(-.5ex - (.6ex - .36em));
    fill: currentColor;
}
.s-loading > .s-svg[data-v-23757d58] {
    display: block;
    margin: 0 auto 30px;
    width: 116px;
    height: 98px;
